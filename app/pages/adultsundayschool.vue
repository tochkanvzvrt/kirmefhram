  ...
  <div class="w-full">
    ...
    <section class="bg-white py-16">
      <div class="mx-auto px-4 lg:px-8 container">
        ...
        <div class="text-center">
          <NuxtLink :to="`/news?category=${ADULT_SUNDAY_SCHOOL_CATEGORY_ID}`" class="inline-flex items-center gap-2 text-primary hover:underline">
            Все новости
            <ArrowRight class="w-4 h-4" />
          </NuxtLink>
        </div>
    ...
    <section class="bg-white py-16">
      <div class="mx-auto px-4 lg:px-8 container">
        ...
        <div class="text-center">
          <NuxtLink :to="`/announcements?category=${ADULT_SUNDAY_SCHOOL_CATEGORY_ID}`" class="inline-flex items-center gap-2 text-primary hover:underline">
            Все анонсы
            <ArrowRight class="w-4 h-4" />
          </NuxtLink>
        </div>
