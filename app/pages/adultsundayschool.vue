  ...
  <div class="w-full">
    ...
    <section class="bg-white py-16">
      <div class="mx-auto px-4 lg:px-8 container">
        ...
        <div v-if="latestAdultSundaySchoolNews.length === 0" class="py-16 text-center">
        ...
        <div class="text-center">
          <NuxtLink :to="`/news?category=${ADULT_SUNDAY_SCHOOL_CATEGORY_ID}`"
    ...
    <section class="bg-white py-16">
      <div class="mx-auto px-4 lg:px-8 container">
        ...
        <div v-if="latestAdultSundaySchoolAnnouncements.length === 0" class="py-16 text-center">
        ...
        <div class="text-center">
          <NuxtLink :to="`/announcements?category=${ADULT_SUNDAY_SCHOOL_CATEGORY_ID}`"
            class="inline-flex items-center gap-2 text-primary hover:underline">
            Все анонсы
            <ArrowRight class="w-4 h-4" />
          </NuxtLink>
    ...
    <section class="bg-white py-16">
      <div class="mx-auto px-4 lg:px-8 container">
        ...
        <div v-if="latestAdultSundaySchoolGalleries.length === 0" class="py-16 text-center">
          <p class="text-muted-foreground">Галерей пока нет</p>
        </div>

        <div v-else class="gap-8 grid grid-cols-1 md:grid-cols-2 mx-auto mb-8 max-w-5xl">
          <NuxtLink v-for="item in latestAdultSundaySchoolGalleries" :key="item.id" :to="getGalleryUrl(item)"
            class="block">
        ...
        <div class="text-center">
          <NuxtLink :to="`/gallery?category=${ADULT_SUNDAY_SCHOOL_CATEGORY_ID}`"
            class="inline-flex items-center gap-2 text-primary hover:underline">
            Все галереи
            <ArrowRight class="w-4 h-4" />
          </NuxtLink>
